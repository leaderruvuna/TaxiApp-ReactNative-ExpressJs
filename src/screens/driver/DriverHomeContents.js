            ...
            firebase
               ...
               .then(function (snapshot) {
                  if (snapshot.exists()) {
                     ...
                     RiderPickUpLatitude = snapshot
                        .child('pickupLatitude')
                        .val();
                     RiderPickUpLongitude = snapshot
                        .child('pickupLongitude')
                        .val();
                     RiderDropUpLatitude = snapshot
                        .child('dropOffLatitude')
                        .val();
                     RiderDropUpLongitude = snapshot
               ...
               .then(
                  () => {
                     console.log(
                        'fine' + RiderDropUpName + '' + RiderPickUpName,
                     );
                     if (!RiderID == '') {
                        this.setState({
                           isModalVisible: true,
