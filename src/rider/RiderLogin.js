	...
	render() {
        ...
        */}
					...
					<View style={styles.socialMedia}>
						<TouchableOpacity style={styles.googlePlusButton} onPress={() => alert('this is google+')}>
							<Image source={require('../Images/googleplus.png')} style={{ width: 20, height: 20 }} />
							{/*<Text style={{color:'#B71C1C',fontWeight:'bold'}}>Google+</Text>*/}
						</TouchableOpacity>
						<TouchableOpacity style={styles.facebookButton} onPress={() => alert('this is facebook')}>
					...
					<View style={{ flexDirection: 'row' }}>
						<View style={{ marginTop: 15, marginLeft: 10 }}>{/*<PhoneInput ref='phone'/>*/}</View>
						<TextInput
					...
					<TouchableOpacity
						...
						<Text style={{ color: '#42A5F5', fontWeight: 'bold' }}>password forgotten?</Text>
					</TouchableOpacity>
					<ActivityIndicator
						size='large'
						//color="#42A5F5"
