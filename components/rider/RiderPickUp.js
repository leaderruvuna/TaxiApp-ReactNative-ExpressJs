...
import { StyleSheet, Text, View ,Button,AsyncStorage,createDrawerNavigator,TouchableOpacity,Image,TouchableHighlight,KeyboardAvoidingView} from 'react-native';
    ...
    return (
      ...
      <Container style={{flex:1}}>
       ...
       <Header style={{backgroundColor:'#42A5F5',height:75}}>
          ...
          <Body>
            <Text style={{color:'#ffffff',fontSize:20,fontWeight:'bold',marginTop:20}}>Locations</Text>
          </Body>
  ...
  */
    //store rider informations
     ...
     .then(riderID => 
      ...
      firebase.database().ref('Ride_Request/'+riderID).set({
        driverID:driverID
       }).then(()=>{
     ...
     .then(riderID => 
      ...
      firebase.database().ref('Ride_Request/'+driverID+"/").set({
        riderID:riderID,
...
const  GooglePlacesInput=  ()=>{
  ...
  return (
    <GooglePlacesAutocomplete
      ...
      debounce={200} 
      renderLeftButton={()  => <Image style={{width:25,height:25,marginTop:10,marginLeft:15}} source={require('../Images/pickup.png')}/>}
...
const  GooglePlacesDropOff=  ()=>{
  ...
  return (
    <GooglePlacesAutocomplete
      ...
      debounce={200} 
      renderLeftButton={()  => <Image style={{width:25,height:25,marginTop:10,marginLeft:15}} source={require('../Images/dropoff.png')}/>}
      renderRightButton={() => <Text></Text>}
    />
  );
