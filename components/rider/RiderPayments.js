...
import { StyleSheet, Text, View ,Button,AsyncStorage,Image,TouchableHighlight,TouchableOpacity,Alert} from 'react-native';
...
export default class RiderPayments extends React.Component {
  ...
  render() {
      ...
      <Container style={{flex:1}}>
       ...
       <Icon
        ...
        / >
          ...
          <Body>
            <Text style={{color:'#ffffff',fontSize:20,fontWeight:'bold',marginTop:20}}>Payments</Text>
          </Body>
    ...
    */}
    <Card>
     <CardItem style={{marginTop:5}}>
       <Body style={{flexDirection:'row'}}>
         ...
         <Text style={{color:'gray',fontSize:20,marginTop:5,marginLeft:5}}>Paypal</Text>
         <CheckBox
          style={{padding: 10,position:'absolute',left:280,width:50,height:50}}
    ...
    <Card>
     <CardItem style={{marginTop:5}}>
       <Body style={{flexDirection:'row'}}>
         <Image source={require('../Images/mobileMoney.png')} style={{height:50,width:50}}/>
         <Text style={{color:'gray',fontSize:20,marginTop:5,marginLeft:5}}>MOBILE MONEY</Text>
         <CheckBox
          style={{padding: 10,position:'absolute',left:280,width:50,height:50}}
          isChecked={this.state.MobileMoney}
          onClick={()=>this.setState({MobileMoney:!this.state.MobileMoney})}
          checkBoxColor="#42A5F5"
   ...
   <Card>
    <CardItem style={{marginTop:5}}>
      <Body style={{flexDirection:'row'}}>
        <Image source={require('../Images/cash.png')} style={{height:50,width:50}}/>
        <Text style={{color:'gray',fontSize:20,marginTop:5,marginLeft:5}}>CASH</Text>
        <CheckBox
         style={{padding:10,position:'absolute',left:280,width:50,height:50}}
  ...
  <Card>
    <CardItem style={{marginTop:5}}>
      <Body style={{flexDirection:'row'}}>
        <Image source={require('../Images/bitcoin.png')} style={{height:50,width:50}}/>
        <Text style={{color:'gray',fontSize:20,marginTop:5,marginLeft:5}}>BITCOIN</Text>
        <CheckBox
         style={{padding:10,position:'absolute',left:280,width:50,height:50}}
         onClick={()=>this.setState({Bitcoin:!this.state.Bitcoin})}
 ...
 _addPaymentsToRiderDatabase= async()=>{
   ...
   AsyncStorage.getItem('riderId')
      .then(riderID => 
        ...
        firebase.database().ref(`Payments/${riderID}/PaymentsMode/`).set({
