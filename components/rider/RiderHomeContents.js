    ...
    return (
      <Container>
       ...
       <Header style={{backgroundColor:'#42A5F5',height:75}}>
          ...
          <Body>
                <Text style={{color:'#ffffff',fontSize:20,fontWeight:'bold',marginTop:20}}>Taxi App</Text>
          </Body>
      ...
      >
          ...
          <Image  source={require('../Images/marker.png')} style={{width:100,height:100,borderRadius:100}}  />
        </MapView.Marker>


       
        <Image  source={require('../Images/driver_car.png')} 
        style={{width:30,height:60,position:'absolute',top:150,left:100}} 
        
        />
         <Text style={{width:30,height:60,position:'absolute',top:150,left:100,elevation:10}} >John</Text>
        <Image  source={require('../Images/driver_car.png')} 
        style={{width:30,height:60,position:'absolute',top:150,left:250}} 
        
        />
        <Text style={{width:30,height:60,position:'absolute',top:150,left:250,elevation:10}} >John</Text>
        <Image  source={require('../Images/driver_car.png')} 
        style={{width:30,height:60,position:'absolute',top:250,left:170}} 
      ...
      <Card style={styles.searchBoxView} >
            <Image style={styles.pickupImage} source={require('../Images/pickup.png')}/>
            <TextInput style={styles. DropUpLocation}
      ...
      <View style={{width:300,height:70,backgroundColor:"#ffffff",position:'absolute',flexDirection:'row'}}>
         <Image  source={require('../Images/avatar.png')} style={{width:50,height:50,borderRadius:50,marginTop:10,marginLeft:7}}  />
         <Text style={{fontSize:18,marginTop:18,fontWeight:'bold'}}>{RiderHomeContents.Firstname +" "+RiderHomeContents.Lastname }</Text>
         <Text style={{fontSize:18,marginTop:18,color:'#42A5F5'}}> Accepted</Text>
      </View>
       :null
      }
