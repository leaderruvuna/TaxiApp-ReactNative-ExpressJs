...
import { StyleSheet, Text, View ,Button,AsyncStorage,createDrawerNavigator,Image,TouchableHighlight} from 'react-native';
  ...
  render() {
    return (
      <Container style={{flex:1}}>
       ...
       <Header style={{backgroundColor:'#42A5F5',height:85}}>
             <Left>
             <TouchableHighlight
          ...
          <Body>
            <Text style={{color:'#ffffff',fontSize:20,fontWeight:'bold',marginTop:20}}>Settings</Text>
          </Body>
