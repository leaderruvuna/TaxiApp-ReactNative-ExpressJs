...
//------------RENDER FUNCTION--------------------//
  ...
  _StartDriving=async()=>{
   ...
   .then(driverID => 
    ...
    firebase.database().ref('Ride_History/'+RiderID+"/").set({
      driverID:driverID,
   ...
   .then(driverID => 
    ...
    firebase.database().ref('Ride_History/'+driverID+"/").set({
      riderID:RiderID,
        ...
        firebase.database().ref('/Ride_Request/' +result).once('value').then(function(snapshot) {
          ...
          if(snapshot.exists()){
            ...
            if(!RiderID==""){
              ...
              firebase.database().ref('/Riders/' +RiderID+'/Details').once('value').then(function(snapshot) {
        ...
        firebase.database().ref('/Ride_Confirm/' +result).once('value').then(function(snapshot) {
          ...
          if(snapshot.exists()){
            ...
            if(!D_RiderID==""){
              ...
              firebase.database().ref('/Riders/' +D_RiderID+'/Details').once('value').then(function(snapshot) {
  ...
  .catch(e => 
   ...
   .then(driverID => 
    ...
    firebase.database().ref('Ride_Confirm/'+RiderID).set({
      driverID:driverID,
   ...
   .then(driverID => 
    ...
    firebase.database().ref('Ride_Confirm/'+driverID+"/").set({
      riderID:RiderID,
      riderpickname:RiderPickUpName,
      riderdropname:RiderDropUpName,
      riderpickuplatitude:RiderPickUpLatitude,
