...
import { StyleSheet, Text, View ,Button,YellowBox,AsyncStorage,TouchableOpacity,TouchableHighlight,TextInput,KeyboardAvoidingView,Image,Platform,ActivityIndicator} from 'react-native';
...
export default class DriverLicence extends React.Component {
    ...
    return (
      <Container style={styles.wrapper}>
       ...
       <Header style={{backgroundColor:'#42A5F5',height:75}}>
          ...
          <Body>
            <Text style={{color:'#ffffff',fontSize:20,fontWeight:'bold',marginTop:20}}>Driver Licence</Text>
          </Body>
  ...
  _addDriverLicence= async()=>{
   ...
   if(DriverID){
   firebase.database().ref(`Drivers/${DriverID}/DriverLicence/`).set({
